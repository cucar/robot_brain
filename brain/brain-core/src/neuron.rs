...
impl Neuron {
    ...
    /// whole history of [distance to the current best entry − distance to the candidate], counted
    /// only on the frames the candidate is strictly closer (the frames it would win); cost = 1 + |O|.
