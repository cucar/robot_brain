...
A neuron keeps a [history](algorithm.md#53-the-history) one horizon wide and deletes a child the moment it stops
covering its own storage. Forgetting is the retire half of the [margin](algorithm.md#56-the-margin) and needs no
