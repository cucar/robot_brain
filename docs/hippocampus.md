...
every neuron, event and action alike (§8.1), and it holds both directions replay needs: what a situation is
...
(the cortex, §8.1), and replay writes imagined ones into the same connections (the hippocampus, "Action
