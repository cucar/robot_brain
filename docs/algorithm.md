...
> set of neighbors the pattern names, constants and variables alike. Every neighbor is decided independently,
...
>           asks to subsume, those its variables were fit by among them
