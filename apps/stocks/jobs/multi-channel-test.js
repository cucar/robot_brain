...
export default class MultiChannelTest extends Job {
	...
	async initialize() {
		...
		// Declared after all channels are registered so the names resolve. Temporal is unaffected —
		// it has no neighborhood and always sequences against every active neuron.
